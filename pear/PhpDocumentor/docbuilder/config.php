...
if ('/Users/pasindu/git/UoC/e-commerce-site/pear' != '@'.'DATA-DIR@')
{
    $root_dir = 'PhpDocumentor';
    $path = '/Users/pasindu/git/UoC/e-commerce-site/pear/PhpDocumentor/docbuilder/images/';

    /**
    * common file information
    */
    include_once("PhpDocumentor/phpDocumentor/common.inc.php");
    include_once("/Users/pasindu/git/UoC/e-commerce-site/pear/PhpDocumentor/docbuilder/includes/utilities.php" );

    // find the .ini directory by parsing phpDocumentor.ini and extracting _phpDocumentor_options[userdir]
    $ini = phpDocumentor_parse_ini_file('/Users/pasindu/git/UoC/e-commerce-site/pear/PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
    	$configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
    	$configdir =  '/Users/pasindu/git/UoC/e-commerce-site/pear/PhpDocumentor/user';
    }
} else {
