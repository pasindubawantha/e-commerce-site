...
if ('/Users/pasindu/git/UoC/e-commerce-site/pear' != '@'.'WEB-DIR@')
{
    /**
    ...
    */
    ...
    require_once( '/Users/pasindu/git/UoC/e-commerce-site/pear' . PATH_DELIMITER . 'PhpDocumentor/docbuilder/includes/utilities.php' );
    ...
    $ini = phpDocumentor_parse_ini_file('/Users/pasindu/git/UoC/e-commerce-site/pear' . PATH_DELIMITER . 'PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
        $configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
        $configdir = '/Users/pasindu/git/UoC/e-commerce-site/pear' . PATH_DELIMITER . 'PhpDocumentor/user';
    }
} else {
